...
(function() {
  ...
  /*
    ...
    **some words** - strong emphasis
    ...
    =[1-6] paragraph - heading (level 1-6, defaults to 1 if no number given)
  ...
  BoundaryFinder.prototype.process = function(text, features) {
    ...
    for (var i = 0; i < features.length; i++) {
      ...
      default:
        ...
        // Headings are matched as '=', '=1', ..., '=6'; anything
        // starting with '=' is treated as a heading feature.
        if (feature.feature === '' ) {
          // Blank line, new paragraph.
          this.simplePara('paragraph');
        } else if (feature.feature === '---') {
          // Horizontal rule, also forces a new paragraph.
          this.simplePara('paragraph', 'hrule');
        } else if (feature.feature === '>') {
          // This paragraph is a quote.
          this.continuablePara('quotation');
        } else if (feature.feature === '>>') {
          // This paragraph is a quote attribution.
          this.continuablePara('attribution');
        } else if (feature.feature.charAt(0) === '=') {
          // This paragraph is a heading; the optional digit gives
          // the level (1-6), defaulting to 1 if omitted.
          var level = feature.feature.length > 1 ?
            feature.feature.substring(1) : '1';
          this.continuablePara('heading-' + level);
        }
        break;
      }
    }
  ...
  var _typesToTrimWhitespace = function(type) {
    return type === 'paragraph' ||
      type === 'quotation' ||
      type === 'attribution' ||
      _headingRe.test(type);
  };
